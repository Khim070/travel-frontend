                                    ...
                                    <details className='group [&_summary::-webkit-details-marker]:hidden'>
                                        ...
                                        <div className="grid grid-cols-1 gap-y-8 sm:grid-cols-6">
                                            ...
                                            <div className="sm:col-span-2 px-5">
                                                ...
                                                <div className="col-span-full">
                                                    <label className="block text-xl font-medium leading-6 text-white-900 mt-3">
                                                        Type
                                                    </label>
                                                    <div className="mt-3">
                                                ...
                                                <div className="col-span-full">
                                                    <label class="inline-flex items-center cursor-pointer mt-5">
                                                        <span className="mr-4 block text-xl font-medium leading-6 text-white-900">Delete</span>
