                            ...
                            <form className="space-y-6" onSubmit={handleLogin}>
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        <input
                                            ...
                                            type="text"
                                            required class="w-full text-sm border border-gray-300 px-4 py-3 rounded-md outline-[#333]"
                                ...
                                <div class="flex items-center justify-between gap-2">
                                    <div class="flex items-center">
                                        <input id="show-password" onClick={() => setShowpassword(!showpassword)} name="show-password" type="checkbox" class="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-gray-300 rounded cursor-pointer" />
                                        <label for="show-password" class="ml-3 block text-sm cursor-pointer">
                                            Show password
                                        </label>
                                    </div>
                                </div>
